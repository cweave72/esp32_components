...
{
    LOGPRINT_VERBOSE("%s: write enter: avail=%u; wrIdx=%u; rdIdx=%u",
        fifo->name,
    ...
    LOGPRINT_VERBOSE("%s: write exit: avail=%u; wrIdx=%u; rdIdx=%u",
        fifo->name,
        (unsigned int)count(fifo),
        (unsigned int)fifo->wrIdx,
        (unsigned int)fifo->rdIdx);
...
{
    LOGPRINT_VERBOSE("%s: read enter: avail=%u; wrIdx=%u; rdIdx=%u",
        fifo->name,
        (unsigned int)count(fifo),
        (unsigned int)fifo->wrIdx,
        (unsigned int)fifo->rdIdx);
    ...
    LOGPRINT_VERBOSE("%s: read exit: avail=%u; wrIdx=%u; rdIdx=%u",
        fifo->name,
        (unsigned int)count(fifo),
        (unsigned int)fifo->wrIdx,
        (unsigned int)fifo->rdIdx);
